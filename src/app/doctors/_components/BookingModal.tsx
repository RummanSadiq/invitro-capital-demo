      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              <MapPin size={12} className={classNames("mr-1")} />
        ...
        <div className={classNames("pt-2")}>
          {!!availableDates.length ? (
            ...
            >
              <TabsList className={classNames("mb-3 w-full")}>
                          ...
                          .map((slot) => (
                            ...
                            >
                              ...
                              <Label
                                htmlFor={slot.id}
                                className={classNames(
                                  "flex flex-col p-2 sm:p-3 border rounded-md cursor-pointer hover:bg-gray-50 peer-data-[state=checked]:border-blue-500 peer-data-[state=checked]:bg-blue-50",
                                )}
                              >
                                <div
                                  className={classNames(
